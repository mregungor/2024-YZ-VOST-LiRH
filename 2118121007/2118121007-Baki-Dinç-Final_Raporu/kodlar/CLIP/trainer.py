...
parser.add_argument("--dataset", type=str,default= "shanghaitech_a", required=False, help="The dataset to train on.")
...
parser.add_argument("--count_loss", type=str, default="mae", choices=["mae", "mse", " dmcount"], help="The loss "
                                                                                                     "function for "
                                                                                                     "count.")
parser.add_argument('--weight_ot', type=float, default=0.5, help='Description of weight_ot')
parser.add_argument('--weight_tv', type=float, default=0.5, help='Description of weight_tv')
...
parser.add_argument("--warmup_epochs", type=int, default=50, help="Number of epochs for warmup. The learning rate "
                                                                  "will increase from eta_min to lr.")
...
parser.add_argument("--total_epochs", type=int, default=260, help="Number of epochs to train.")
...
def determine_file_type(file_path):
    ...
    return file_extension[1:]  # Uzantıdaki "." karakterini kaldırır

def main():
    
    file_path = r"C:\Users\bakiD\OneDrive\Belgeler\CLIP-EBC-main7\data\ShanghaiTech\part_A\train_data\ground-truth\GT_IMG_180.mat"
    file_type = determine_file_type(file_path)
    print("Dosya türü:", file_type)
    import scipy.io
    loaded_data = scipy.io.loadmat('C:/Users/bakiD/OneDrive/Belgeler/CLIP-EBC-main7/data/ShanghaiTech/part_A/train_data/ground-truth/GT_IMG_3.mat')
