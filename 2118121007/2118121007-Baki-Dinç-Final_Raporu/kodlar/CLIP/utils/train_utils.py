...
def load_checkpoint(
    ...
    ck=r"C:\Users\bakiD\OneDrive\Belgeler\CLIP-EBC-main7\checkpoints\sha\clip_resnet50_number_448_8_4_fine_1.0_dmcount_aug"
    ckpt_path = os.path.join(ck, "best_mae.pth")
    #print("ne buuuu1111",args.ckpt_dir)
    print("ne buuuu",ckpt_path)
     
    # İçeriği görüntüleyin
    #print("ICERIK",checkpoint_content)
    #model.load_state_dict(ckpt)
    checkpoint =torch.load(ckpt_path)
    # Print the keys in the checkpoint
    print("Print the keys in the checkpoint",checkpoint.keys())
