...
from sklearn.ensemble import RandomForestClassifier # kutuphanemiz
...
job = RandomForestClassifier(n_estimators=10,criterion="entropy")
job.fit(train_x,train_y)


pred = job.predict(train_x)
