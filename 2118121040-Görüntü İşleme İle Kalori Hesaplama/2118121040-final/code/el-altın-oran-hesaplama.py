# -*- coding: utf-8 -*-
"""
Created on Sat May  4 11:08:50 2024
        ...
        if results_hand.multi_hand_landmarks:
            for (idx, hand_landmarks) in enumerate(results_hand.multi_hand_landmarks):
                ...
                if idx == 0:  # Sağ el
                    ...
                    x3, y3 = int(hand_landmarks.landmark[8].x * image_width), int(hand_landmarks.landmark[8].y * image_height)
                    x4, y4 = int(hand_landmarks.landmark[6].x * image_width), int(hand_landmarks.landmark[6].y * image_height)
                    ...
                    text_x = x1 + 30
                    text_y = y1
                    cv2.putText(image, "{:.2f}".format(float(right_distance1 / right_distance2)), (text_x, text_y), cv2.FONT_HERSHEY_COMPLEX, 1, (255, 0, 128), 3)
